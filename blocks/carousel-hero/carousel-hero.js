 ...
 * Carousel (hero) block.
 *
 * Adapted from the AEM Block Collection carousel for this project's boilerplate:
 * - Removed the `fetchPlaceholders` import (not exported by this project's aem.js);
 *   accessible labels are inlined with sensible English defaults.
 ...
 * - CSS class names are scoped to the `carousel-hero` variant.
 */
